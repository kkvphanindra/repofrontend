...
const ProfileEdit = ({navigation, route}) => {
  ...
  const [profileFilepath, setProfileFilepath] = useState({data: '', uri: ''});
  const [profileFileData, setProfileFileData] = useState('');
  const [profileFileUri, setProfileFileUri] = useState('');
  const [coverFilepath, setCoverFilepath] = useState({data: '', uri: ''});
  const [coverFileData, setCoverFileData] = useState('');
    ...
    ImagePicker.launchImageLibrary(options, response => {
      if (response !== undefined) {
        ...
        if (response.didCancel) {
          ...
          console.log('cover response.uri', response?.assets[0]?.uri);
          setCoverFilepath(response);
  ...
  const onSubmit = () => {
    dispatch(
      profileUpdate(
        ...
        res.bio,
        res.occupation,
        res.studiedAt == undefined ? '' : res.studiedAt,
    ...
    <ScrollView
      ...
      <View style={styles.container}>
        <View style={styles.topContainer}>
          <Pressable
            onPress={() => navigation.goBack(profileDetails.userId)}
        ...
        <View style={styles.wrapper}>
          <ImageBackground
            ...
            <Image
              ...
              source={
                profileFileUri === ''
                  ? require('../assets/images/contact-pic.png')
                  : {
                      uri: profileFileUri,
                    }
              }
        ...
        <View style={styles.mainWrapper}>
          ...
          <View style={styles.imageWrapper}>
            ...
            />
            <Pressable
              onPress={launchCoverImageLibrary}
        ...
        <View style={styles.formContainer}>
          <View style={styles.formFlex}>
            ...
            <TextInput
              placeholder="Please fill in your BIO"
              value={res.bio}
              onChangeText={e => {
                handleChangeEdit('bio', e);
              }}
              multiline
              numberOfLines={4}
              style={[
          ...
          <View style={styles.formFlex}>
            ...
            <TextInput
              placeholder="Auto filled can be edited"
              value={res.occupation}
              onChangeText={e => {
                handleChangeEdit('occupation', e);
              }}
